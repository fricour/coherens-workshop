...
::: {style="position:absolute;top:30%;left:60%;font-size:30px;"}
$$
...
::: {style="position:absolute;top:50%;left:60%;font-size:30px;"}
![](images/activation_function_cropped.jpg){}
:::
...
::: {style="position:absolute;top:20%;left:55%;font-size:30px;"}
